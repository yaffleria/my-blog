---
title: 'Kraken Robotics: 기업 심층 분석'
date: '2025-12-26'
summary: 'Kraken Robotics($KRKNF, $PNG) 기업 분석. 수중 로보틱스 시장의 숨은 강자. Anduril, HII, Kongsberg 등 글로벌 방산 기업에게 핵심 하부 시스템을 독점 공급하는 캐나다 수중 로봇 전문 기업. SeaPower 배터리와 AquaPix 소나 기술의 경쟁 우위, RaaS 비즈니스 모델 전환, 2024년 매출 9,100만 달러에서 2025년 목표 1억 3,500만 달러까지의 성장 전략을 심층 분석합니다.'
tags:
  [
    'Kraken Robotics',
    'KRKNF',
...
<div className="-mx-2 flex flex-wrap overflow-hidden xl:-mx-2">
  <div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:w-full xl:px-2">
    <Image
      alt="SeaPower 압력 내성 배터리"
      src="/static/images/kraken-robotics/kraken-robotics-seapower.jpg"
      width={1200}
      height={630}
      className="w-full rounded-lg object-cover"
    />
...
<div className="-mx-2 flex flex-wrap overflow-hidden xl:-mx-2">
  <div className="my-1 w-full overflow-hidden px-2 xl:my-1 xl:w-full xl:px-2">
    <Image
      alt="Anduril Industries 파트너십"
      src="/static/images/kraken-robotics/kraken-robotics-anduril.gif"
      width={1200}
      height={630}
      className="w-full rounded-lg object-cover"
    />
